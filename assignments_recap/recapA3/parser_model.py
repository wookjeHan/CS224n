...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        torch.nn.init.uniform_(self.embed_to_hidden_bias)
        ...
        torch.nn.init.uniform_(self.hidden_to_logits_bias)
    ...
    def forward(self, w):
        ...
        hiddens=nn.functional.relu(torch.matmul(embedded,self.embed_to_hidden_weight)+self.embed_to_hidden_bias)
        hiddens=self.dropout(hiddens)
        logits=torch.matmul(hiddens,self.hidden_to_logits_weight)+self.hidden_to_logits_bias
